...
(require('./core_modules/config/index'))(Meanio);
(require('./menu'))(Meanio);
(require('./core_modules/module/index'))(Meanio);
(require('./core_modules/db/index'))(Meanio);
(require('./core_modules/server/index'))(Meanio);
